    ...
    public void handle(KeyEvent key){
            ...
            switch (key.getCode()){
                case A:
                    ...
                    ventana.cambiarImagenJugador(new Image("JugadorIzquierda.png"));
                    break;
                case S:
                    jugador.moverAbajo();
                    ventana.cambiarImagenJugador(new Image("JugadorAbajo.png"));
                    break;

                case D:
                    jugador.moverDerecha();
                    ventana.cambiarImagenJugador(new Image("JugadorDerecha.png"));
                    break;

                case W:
                    jugador.moverArriba();
                    ventana.cambiarImagenJugador(new Image("JugadorArriba.png"));
                    break;
