...
public class InventarioHerramientas extends GridPane {
    ...
    public InventarioHerramientas(Constructor constructor, InventarioLayout inventarioLayout, Jugador jugador) {
        ...
        botonHerramienta = new BotonInventarioHerramienta(new Image("BotonHachaMadera.png")
        ...
        botonHerramienta = new BotonInventarioHerramienta(new Image("BotonHachaPiedra.png")
                ,constructor.crearHachaDePiedra(), jugador, inventarioLayout);
        this.add(botonHerramienta, 1, 0, 1, 1);

        botonHerramienta = new BotonInventarioHerramienta(new Image("BotonHachaMetal.png")
                ,constructor.crearHachaDeMetal(), jugador, inventarioLayout);
        this.add(botonHerramienta, 2, 0, 1, 1);

        botonHerramienta = new BotonInventarioHerramienta(new Image("BotonPicoMadera.png")
                ,constructor.crearPicoDeMadera(), jugador, inventarioLayout);
        this.add(botonHerramienta, 3, 0, 1, 1);

        botonHerramienta = new BotonInventarioHerramienta(new Image("BotonPicoPiedra.png")
                ,constructor.crearPicoDePiedra(), jugador, inventarioLayout);
        this.add(botonHerramienta, 4, 0, 1, 1);

        botonHerramienta = new BotonInventarioHerramienta(new Image("BotonPicoMetal.png")
                ,constructor.crearPicoDeMetal(), jugador, inventarioLayout);
        this.add(botonHerramienta, 5, 0, 1, 1);

        botonHerramienta = new BotonInventarioHerramienta(new Image("BotonPicoFino.png")
        ...
        for(int i=7; i<9; i++){
            botonVacio = new BotonVacio(new Image("BotonVacio.png"));
