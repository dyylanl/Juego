...
public class InventarioMateriales extends GridPane {
    ...
    public InventarioMateriales(MaterialSeleccionado materialSeleccionado, InventarioLayout inventarioLayout, Jugador jugador) {
        ...
        botonInventarioMaterial = new BotonInventarioMaterial(materialSeleccionado, new Image("BotonMadera.png")
                , new Madera(), jugador);
        this.add(botonInventarioMaterial, 0, 0, 1, 1);

        botonInventarioMaterial = new BotonInventarioMaterial(materialSeleccionado, new Image("BotonPiedra.png")
                , new Piedra(), jugador);
        this.add(botonInventarioMaterial, 1, 0, 1, 1);

        botonInventarioMaterial = new BotonInventarioMaterial(materialSeleccionado, new Image("BotonMetal.png")
                , new Metal(), jugador);
        this.add(botonInventarioMaterial, 2, 0, 1, 1);

        botonInventarioMaterial = new BotonInventarioMaterial(materialSeleccionado, new Image("BotonDiamante.png")
